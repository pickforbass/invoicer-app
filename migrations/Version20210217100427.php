 ...
 */
final class Version20210217100427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD client_id INT DEFAULT NULL, ADD paid TINYINT(1) DEFAULT NULL, ADD date DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoice DROP client_id, DROP paid, DROP date');
    }
}
